...
curl -X POST 'https://login.microsoftonline.com/edf6f660-7319-45db-8531-fdbd46047921/oauth2/v2.0/token' \
  ...
  -d 'client_id=51d7fe82-f122-4651-a4fd-262c2b2df967&grant_type=client_credentials&client_assertion=eyJhbGciOiJFUzI1NiJ9.
 ...
 QuFxyCRIklrxsMk32MfNF_ABA&client_assertion_type=urn%3Aietf%3Aparams%3Aoauth%3Aclient-assertion-type%3Ajwt-bearer&scope=https://graph.microsoft.com/.default'
```
### Output
```
{
